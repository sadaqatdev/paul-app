...
class itemDetail {
  ...
  itemDetail({this.name, this.type, this.price, this.img, this.iconss});
}
...
List OderList = [
  OrderDetail(itemname: "Bracelet x 1", price: "\$85"),
  OrderDetail(itemname: "Watch", price: "\$5"),
  OrderDetail(itemname: "Rings", price: "\$23"),
];
// ***************************************************************
...
List reviewsList = [
  reviewDetail(comment: "Really good", rating: "4"),
  reviewDetail(
      comment:
          "feeling happy with 99 others at sector J street 22 house 29 DHA phase 2",
      rating: "3"),
  reviewDetail(comment: "really bad", rating: "2"),
];
...
class CatorgeryDetail {
  ...
  CatorgeryDetail({this.name, this.img, this.Titems});
}
...
List PurchasesList = [
  ...
  itemDetail(
      name: "Toys", img: "images/64.png", price: "200 ", type: "Cloths Toys"),
];
...
List mySalesList = [
  ...
  itemDetail(
      name: "Toys", img: "images/64.png", price: "200 ", type: "Cloths Toys"),
  itemDetail(
      name: "Rings", img: "images/64.png", price: "120 ", type: "Real Gold"),
];
...
List jewelryList = [
  itemDetail(
      ...
      type: "Signet Cuff Bracelet"),
  itemDetail(
      name: "Toys", img: "images/toys.png", price: "200 ", type: "Cloths Toys"),
  itemDetail(
      name: "Rings", img: "images/rings.png", price: "120 ", type: "Real Gold"),
];
...
class followingDetails {
  ...
  followingDetails({this.title, this.profile, this.city, this.followType});
}
...
class purchaseDetail {
  ...
  purchaseDetail({this.name, this.price, this.img, this.num});
}

List PurchasesDetailList = [
  purchaseDetail(
      name: "Bracelets", img: "images/64.png", price: "400 ", num: 2),
  purchaseDetail(name: "Toys", img: "images/64.png", price: "200 ", num: 1),
];
